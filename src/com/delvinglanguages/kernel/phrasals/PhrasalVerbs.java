...
public class PhrasalVerbs implements Runnable, Serializable {
	...
	private static final String[] swedishPreps = {};
	...
	private BackgroundTaskMessenger handler;

	public PhrasalVerbs(int language, DReferences words, BackgroundTaskMessenger handler) {
	...
	public void run() {
		...
		handler.onTaskDone(-1, BackgroundTaskMessenger.TASK_DONE, this);
	}
