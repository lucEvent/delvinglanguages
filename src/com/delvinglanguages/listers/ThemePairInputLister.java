...
public class ThemePairInputLister extends ArrayAdapter<ThemePair> implements
	...
	private static final String DEBUG = "##ThemePairInputLister##";
	private ThemePairs values;
	private LayoutInflater inflater;
	private OnClickListener edit_listener;

	public ThemePairInputLister(Context context, ThemePairs values,
	...
	public View getView(int position, View view, ViewGroup parent) {
		if (view == null) {
			view = inflater
					.inflate(R.layout.i_theme_pair_create, parent, false);
		}
