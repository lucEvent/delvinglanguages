...
public class Test_1_SelectActivity extends ListActivity implements OnClickListener, OnLongClickListener {
    ...
    public void createTest(View v) {
        ...
        intent.putExtra(AppCode.NUMBER, numero);
        intent.putExtra(AppCode.TYPES, type);
        startActivity(intent);
    }
