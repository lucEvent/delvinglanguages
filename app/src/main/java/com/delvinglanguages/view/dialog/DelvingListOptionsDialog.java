...
public class DelvingListOptionsDialog {

    public AlertDialog dialog;

    public DelvingListOptionsDialog(Context context, View.OnClickListener listener, boolean enablePhrasal)
    {
        View view = LayoutInflater.from(context).inflate(R.layout.d_more_list_options, null);

        view.findViewById(R.id.option_subjects).setOnClickListener(listener);
        if (!enablePhrasal)
