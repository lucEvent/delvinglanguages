...
public class SubjectPairLister extends RecyclerView.Adapter<SubjectPairLister.ViewHolder> {
    ...
    public SubjectPairLister(SubjectPairs dataset)
    {
    ...
    {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.i_subject_pair, parent, false);
    ...
    public void setNewDataSet(SubjectPairs newPairs)
    {
